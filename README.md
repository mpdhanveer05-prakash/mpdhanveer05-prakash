...
const dhanveer = {
  ...
  building:    ["LLM-powered agents", "RAG pipelines", "CI/CD platforms"],
  philosophy:  "Ship fast. Measure honestly. Automate everything.",
  open_to:     ["Collaborations", "Founding-engineer roles", "Open-source"]
};
```
...
> ###### **Engineer at the seam of products and AI.**
> I architect systems that feel inevitable — fast, observable, and intelligent.
> From **multi-tenant SaaS** and **mobile apps** to **autonomous AI agents**
> and **infrastructure pipelines**, I work end-to-end across the modern stack.
>
> Currently obsessed with **MCP servers**, **agentic workflows**,
> and making **AI feel like a teammate, not a tool**.
...
## <img src="https://media.giphy.com/media/eNAsjO55tPbgaor7ma/giphy.gif" width="28"/> &nbsp; Tech Arsenal
...
<p>
  ...
  <img src="https://img.shields.io/badge/Zustand-1A202C?style=for-the-badge&logo=react&logoColor=white" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/Firebase_Hosting-FFCA28?style=for-the-badge&logo=firebase&logoColor=000" />
  <img src="https://img.shields.io/badge/Azure_App_Service-0078D4?style=for-the-badge&logo=microsoftazure&logoColor=white" />
  <img src="https://img.shields.io/badge/Static_Web_Apps-0078D4?style=for-the-badge&logo=microsoftazure&logoColor=white" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/MCP_Servers-6E40C9?style=for-the-badge&logo=anthropic&logoColor=white" />
  <img src="https://img.shields.io/badge/RAG_Systems-FF6F00?style=for-the-badge&logo=databricks&logoColor=white" />
  <img src="https://img.shields.io/badge/Vector_DBs-0F62FE?style=for-the-badge&logo=pinecone&logoColor=white" />
  <img src="https://img.shields.io/badge/AI_Agents-22D3EE?style=for-the-badge&logo=probot&logoColor=black" />
  <img src="https://img.shields.io/badge/Prompt_Engineering-EC4899?style=for-the-badge&logo=openai&logoColor=white" />
  <img src="https://img.shields.io/badge/Workflow_Automation-FF4F8B?style=for-the-badge&logo=zapier&logoColor=white" />
  <img src="https://img.shields.io/badge/Semantic_Search-7C3AED?style=for-the-badge&logo=meilisearch&logoColor=white" />
</p>
...
## <img src="https://media.giphy.com/media/du3J3cXyzhj75IOgvA/giphy.gif" width="28"/> &nbsp; DevOps × AI Automation
...
- Multi-environment **CI/CD** with GitHub Actions & Azure DevOps
- **Docker** + **Kubernetes** deployments with blue/green rollouts
- **Infrastructure-as-Code** with Bicep, Terraform, ARM
- **Observability**: structured logs, traces, dashboards
- **NGINX** reverse proxies and **Cloudflare** edge configs
- Automated **secrets**, **scanning**, and **dependency policy**

</td>
<td width="50%" valign="top">

### 🧠 AI Automation Layer
- **LLM-powered** internal tools & agents (OpenAI / Claude / Gemini)
- **RAG pipelines** on vector DBs (Pinecone, pgvector, Chroma)
- **MCP servers** exposing real systems to AI clients
- **LangChain** orchestration + custom agent loops
- **Semantic search** & enterprise knowledge bases
- **Workflow automation** glueing SaaS APIs end-to-end
...
## <img src="https://media.giphy.com/media/SWoSkN6DxTszqIKEqv/giphy.gif" width="28"/> &nbsp; GitHub Analytics
...
## <img src="https://media.giphy.com/media/UQDSn9rt8JpO8preMA/giphy.gif" width="28"/> &nbsp; Trophy Wall
...
## <img src="https://media.giphy.com/media/jpVnC65DmYeyRL4LHS/giphy.gif" width="28"/> &nbsp; Current Focus & Roadmap

```yaml
now:
  - Shipping AI agents wired through MCP servers
  - Hardening multi-tenant SaaS on Azure + Kubernetes
  - Migrating legacy services to .NET 9 + ASP.NET Core minimal APIs

next:
  - Deeper LLM evals + safety harnesses for production agents
  - Edge-deployed AI with Cloudflare Workers + R2
  - Open-source MCP server template kit

later:
  - Indie AI product launch
  - Technical writing on building reliable AI systems
```

<details>
<summary>🎯 <b>Yearly Themes (click to expand)</b></summary>

<br/>

| Quarter | Theme | Outcome |
|:---|:---|:---|
| **Q1** | Foundations | Hardened core CI/CD + observability for all repos |
| **Q2** | AI-native primitives | MCP server toolkit + RAG production patterns |
| **Q3** | Scale | Multi-region deployments, performance budgets |
| **Q4** | Product | Public release of an AI-first SaaS product |
...
```bash
$ whoami
> a developer who reads collapsible sections.
> respect. drop a ⭐ on any repo and I'll know you found this.
```
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:24243E,50:302B63,100:0F0C29&height=140&section=footer&text=Thanks%20for%20visiting&fontSize=22&fontColor=ffffff&fontAlignY=70&animation=twinkling" alt="footer" />
